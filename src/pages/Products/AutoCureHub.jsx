// File: src/pages/Products/AutoCareHub.jsx
...
const product = {
  ...
  screenshots: [
    "/images/products/auto-1.jpg",
    "/images/products/auto-2.jpg",
    "/images/products/auto-3.jpg",
  ],
  details: {
    launched: "2023",
    version: "1.8",
  ...
  return (
    <section className="bg-gradient-to-br from-[#0f172a] to-black text-white py-20 px-6 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <a href="https://autocure-hub.vercel.app/">
