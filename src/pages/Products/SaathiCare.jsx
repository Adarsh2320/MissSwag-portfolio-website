...
const product = {
  ...
  highlights: [
    ...
    "Emergency Alert Integration with SOS",
...
const SaathiCare = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#0f172a] to-black text-white py-20 px-6 min-h-screen">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1603398938378-3b49f7f850d1')] bg-cover bg-center opacity-70 -z-10"></div>
      ...
      <div className="max-w-6xl mx-auto text-xl">
        ...
        >
          ...
          <p className="text-gray-400">
            With a focus on compassion and technology, Saathi Care empowers families to provide proactive support to elders and patients at home. Features like live vitals tracking, digital health history, and appointment bookings ensure personalized and dependable healthcare.
          </p>
        </motion.div>
